...
return array(
    ...
    */
    'attributes' => array(
        ...
        'raison-soc' => 'Raison sociale',
        'marque-name' => 'Marque',
        'produit-name' => 'Produit',
        'campagne-name' => 'Campagne',
        'dp-campagne' => 'DP campagne',
        'fp-campagne' => 'FP campagne',
        'code-pays' => 'Code pays',
        'etat-campagne' => 'Etat campagne',
        'duree-campagne' => 'Durée Campagne',
        'regie-name' => 'Régie',
        'commune-id' => 'Identifiant',
        'commune-name' => 'Commune',
        'commune-lat' => 'Latitude',
        'commune-lng' => 'Longitude',
        'commune-zoom' => 'Zoom',
        'visuel-name' => 'Emplacement',
        'visuel-part' => 'Part de voix',
        'image' => 'Image',
        'campagne-name-dupliquer' => 'Dupliquer vers campagne',
        'campagne-named' => 'Campagne à dupliquer',*/
        //'image[]' => 'Images',
